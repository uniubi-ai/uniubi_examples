...
| 示例类型 | 实际位置 | 依赖 | 默认安全级别 |
|---|---|---|---|
| C++ SDK | [`uniubi_robot_sdk/examples`](https://github.com/uniubi-ai/uniubi_robot_sdk/tree/main/examples) | [`uniubi_robot_sdk`](https://github.com/uniubi-ai/uniubi_robot_sdk) | 高级首跑安全动作；低级零力矩仅限吊架 / 急停条件；媒体订阅仅 aarch64 板内 |
...
| ROS 2 | [`uniubi_ros2/src/uniubi_interface_test`](https://github.com/uniubi-ai/uniubi_ros2/tree/main/src/uniubi_interface_test) | [`uniubi_robot_msgs`](https://github.com/uniubi-ai/uniubi_robot_msgs) + [`uniubi_ros2`](https://github.com/uniubi-ai/uniubi_ros2) | 只读查询 + 控制权管理 + 音频控制 + 观测上报开关；运动 / TRC 默认关闭 |
